			...
			<div className='content'>
				...
				<div className='project'>
					...
					<div className='text'>
						...
						<p>
							A responsive web-app to manage personal expenses using React and Node.js within 5 months. Consist of 5 pages with functional server: login, register, transactions, accounts, categories.
							<br />
