...
export default function Skills() {
  ...
  return (
    <section className="d-flex flex-column align-items-center py-2 mx-4 border-bottom border-2 border-black">
        <h1>Skills</h1>
        ...
        <div className="d-flex flex-wrap gap-4 justify-content-center">
            {skills && skills.map(obj => <div key={skills.indexOf(obj)} className="card text-center" style={{ width: "225px" }}>
